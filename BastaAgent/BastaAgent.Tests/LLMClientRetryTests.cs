...
public class LLMClientRetryTests
{
    ...
    [Fact]
    public async Task CompleteAsync_RetriesOn5xxAnd429_ThenSucceeds()
    {
        var http = new HttpClient(new FlakyHandler())
        {
        ...
        Assert.Equal("ok", resp.GetMessage()?.Content);
    }
}
